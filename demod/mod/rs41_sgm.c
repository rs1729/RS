...
static int print_position(gpx_t *gpx, int ec) {
    ...
    int encrypted = 0;
    int unexp = 0;
    int pcks[8] = {0,0,0,0,0,0,0,0};
    int dbfrm = 1;
    int pcks_frm = 0, pcks_gps1 = 0, pcks_gps2 = 0, pcks_gps3 = 0;
    ...
    if (output) {
        ...
        while (dbfrm > 0)
        {
            ...
            if (dbfrm > 0) {
                ...
                err1 = get_GPS1(gpx, pcks[3]);
                err3 = get_GPS3(gpx, pcks[7]);
            }
        }
