...
#### Files
  ...
  * `demod_mod.c`, `demod_mod.h`, <br />
    `rs41mod.c`, `rs92mod.c`, `dfm09mod.c`, `m10mod.c`, `mXXmod.c`, `m10m20mod.c`, `lms6mod.c`, `lms6Xmod.c`, `meisei100mod.c`, `imet54mod.c`, `mp3h1mod.c`, `mts01mod.c`, `cf06ht03mod.c`,<br />
...
#### Compile
  ...
  `gcc m10m20mod.c demod_mod.o -lm -o m10m20mod` <br />
  ...
  `gcc mp3h1mod.c demod_mod.o -lm -o mp3h1mod` <br />
  `gcc mts01mod.c demod_mod.o -lm -o mts01mod` <br />
  `gcc cf06ht03mod.c demod_mod.o bch_ecc_mod.o -lm -o cf06ht03mod`

#### Usage/Examples
  `./rs41mod --ecc2 -vx --ptu <audio.wav>` <br />
  `./dfm09mod --ecc -v --ptu <audio.wav>` (add `-i` for dfm06; or use `--auto`) <br />
  `./m10m20mod --dc -vv --ptu -c <audio.wav>` <br />
